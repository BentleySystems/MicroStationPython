...
:param etInstance:
    (input) the IECInstance that contains the properties used by
    MicroStation to get and set element symbology.

:param styleName:
    (input) the name of the detail symbol style to pass to the default
    instance.
...
:param materialId:
    (input) material Id available in modelRef file.

:param modelRef:
    (input) modelRef use as context to look up material by ID.
...
:param material:
    (input) the name of the material to pass to the default instance.

:param palette:
    (input) the name of the palette to pass to the default instance.
...
:param styleId:
    (input) the ID of the dimension style to pass to the default instance.

:param dgnFile:
    (input) file used to look up style by id.
...
:param styleName:
    (input) the name of the dimension style to pass to the default
    instance.
...
:param styleId:
    (input) the ID of the multiline style to pass to the default instance.
...
:param styleName:
    (input) the name of the multiline style to pass to the default
    instance.
...
:param angle1Value:
    (input) the primary angle value to pass to the default instance.

:param angle2Value:
    (input) the secondary angle value to pass to the default instance.
...
:param deltaxValue:
    (input) the delta x value to pass to the default instance.

:param deltayValue:
    (input) the delta y value to pass to the default instance. If this
...
:param scale:
    (input) the scale of the pattern cell to pass to the default instance.
...
:param angle:
    (input) the angle of the pattern cell to pass to the default instance.
...
:param deltayValue:
    (input) the delta y value to pass to the default instance.
...
:param cellName:
    (input) the name of the pattern cell to pass to the default instance.
...
:param textScale:
    (input) the defines the text height and width.

:param textParams:
    (input) defines the text style override values.

:param lineLength:
    (input) defines the line length for mult-line text.

:param modelRef:
    (input) reference model used to calculate UORs to meters since template
...
:param styleId:
    (input) the ID of the text style to pass to the default instance.
...
:param textStyleName:
    (input) the name of the text style to pass to the default instance.
...
:param pointType:
    (input) the point type of the active point to pass to the default
    instance.

:param cellNameOrCharacter:
    (input) the string value used to define the point.
...
:param scale:
    (input) the scale of the terminator cell to pass to the default
    instance.
...
:param cellName:
    (input) the name of the terminator cell to pass to the default
    instance.
...
:param cellScale:
    (input) the scale of the cell to pass to the default instance.

:returns:
    ETSTATUS_Success if a cell scale was successfully added to the
    etInstance.)doc";

static const char* __doc_Bentley_DgnPlatform_ElementTemplateParamsHelper_AddCellFixedSize = R"doc(Add the fixed size on screen for the cells to the template instance.
...
:param cellFixedSize:
    (input) the fixed size on screen in inches of the cell to pass to the default instance.

:returns:
    ETSTATUS_Success if a cell fixed size was successfully added to the
    etInstance.)doc";
...
:param cellName:
    (input) the name of the cell to pass to the default instance.
...
:param fillMode:
    (input) the fill mode setting to pass to the default instance.
...
:param gradientsymb:
    (input) the value of the gradient fill color to pass to the default
    instance.
...
:param elementColor:
    (input) the value of the solid fill color to pass to the default
    instance.

:param dgnFile:
    (input) reference file used to set the solid fill color value to the
...
:param isHole:
    (input) the area mode setting to pass to the default instance.
...
:param priority:
    (input) the value of the priority to pass to the default instance.
...
:param transparency:
    (input) the value of the transparency to pass to the default instance.
...
:param elementClass:
    (input) the value of the element class to pass to the default instance.
...
:param lineStyleParams:
    (input) the parameters of the level to pass to the default instance.

:param modelRef:
    (input) reference model used to search for the line style from the
...
:param linestyleId:
    (input) the value of the line style/line code to pass to the default
    instance.
...
:param levelName:
    (input) the name of the line style to pass to the default instance.
...
:param lineWeight:
    (input) the value of the weight to pass to the default instance.
...
:param elementColor:
    (input) the value of the element color to pass to the default instance.

:param dgnFile:
    (input) file used to look up color by id.
...
:param levelId:
    (input) the ID of the level to pass to the default instance.

:param dgnFile:
    (input) reference file used to set the level id to the associated
    level.
...
:param levelName:
    (input) the name of the level to pass to the default instance.
...
:param index:
    (input) the index in the template instance to assign the new detail
    symbol style name.
...
:param index:
    (input) the index in the template instance to assign the new material
    and palette names.
...
:param dgnFile:
    (input) reference file used to set the id value to the associated
    dimension style.

:param index:
    (input) the index in the template instance to assign the new dimension
    style id.
...
:param index:
    (input) the index in the template instance to assign the new multiline
    style id.
...
:param index:
    (input) the index in the template instance to assign the new hatch
    angle values.
...
:param index:
    (input) the index in the template instance to assign the new pattern
    cell scale.
...
:param textScale:
    (input) the scale of the text to pass to the default instance.

:param textParams:
    (input) the parameters of the text style to pass to the default
    instance.

:param lineLength:
    (input) the line length to pass to the default instance.

:param modelRef:
    (input) reference model used to search for the text style from the
    associated DGNLIB file.

:param index:
    (input) the index in the template instance to assign the new text
    style.
...
:param index:
    (input) the index in the template instance to assign the new text style
    id.
...
:param pointType:
    (input) the point type either zero-length line, cell, character .

:param cellNameOrCharacter:
    (input) the string value used to define the cell name or character.

:param index:
    (input) the index in the template instance to assign the new active
    point type.
...
:param index:
    (input) the index in the template instance to assign the new terminator
    scale.
...
:param index:
    (input) the index in the template instance to assign the new cell
    scale.

:returns:
    ETSTATUS_Success if a cell scale at index is found in etInstance.)doc";

static const char* __doc_Bentley_DgnPlatform_ElementTemplateParamsHelper_SetCellFixedSize = R"doc(Update the fixed size on screen of an existing cell stored within the template
instance.
...
:param cellFixedSize:
    (input) the fixed size on screen of the cell to pass to the default instance.
...
:returns:
    ETSTATUS_Success if a cell fixed size on screen at index is found in etInstance.)doc";
...
:param index:
    (input) the index in the template instance to assign the new cell name.
...
:param index:
    (input) the index in the template instance to assign the new fill mode.
...
:param index:
    (input) the index in the template instance to assign the new gradient
    fill color.
...
:param index:
    (input) the index in the template instance to assign the new solid fill
    color.
...
:param index:
    (input) the index in the template instance to assign the new area mode.
...
:param index:
    (input) the index in the template instance to assign the new priority
    value.
...
:param index:
    (input) the index in the template instance to assign the new
    transparency value.
...
:param index:
    (input) the index in the template instance to assign the new element
    class.
...
:param index:
    (input) the index in the template instance to assign the new line
    style.
...
:param dgnFile:
    (input) reference file used to set the line weight to the associated
    DGNLIB file.

:param index:
    (input) the index in the template instance to assign the new line style
    id.
...
:param index:
    (input) the index in the template instance to assign the new weight.
...
:param dgnFile:
    (input) reference file used to set the element color value to the
    associated element color.
...
:param index:
    (input) the index in the template instance to assign the new level id.
...
:param index:
    (input) the index in the template instance to assign the new level
    name.
...
:param styleName:
    (output) detail symbol style name retrieved from etInstance.
...
:param index:
    (input) the index of the detail symbol style to retrieve.
...
:param matId:
    (output) id of the level retrieved from etInstance.

:param modelRef:
    (input) reference model used to get the material id from the associated
    material name.
...
:param index:
    (input) the index of the material id to retrieve.
...
:param material:
    (output) material name retrieved from etInstance.

:param palette:
    (output) palette name retrieved from etInstance.
...
:param index:
    (input) the index of the material and palette to retrieve.
...
:param file:
    (input) reference file used to get the dimension style from the
...
:param index:
    (input) the index of the dimension style to retrieve.
...
:param styleName:
    (output) dimension style name retrieved from etInstance.
...
:param mlineStyle:
    (output) multiline style of the level retrieved from etInstance.

:param file:
    (input) reference file used to get the multiline style from the
...
:param index:
    (input) the index of the multiline style to retrieve.
...
:param styleName:
    (output) multiline style name retrieved from etInstance.
...
:param angle1Value:
    (output) angle 1 value retrieved from etInstance.

:param angle2Value:
    (output) angle 2 value retrieved from etInstance.
...
:param index:
    (input) the index of the hatch angle to retrieve.
...
:param deltaxValue:
    (output) delta X value in meters.

:param deltayValue:
    (output) delta Y value in meters.
...
:param index:
    (input) the index of the hatch delta to retrieve.
...
:param isAnnotation:
    (output) flag indicating whether this hatch or pattern behaves like an
...
:param index:
    (input) the index of the pattern angle to retrieve.
...
:param angle:
    (output) pattern angle value retrieved from etInstance.
...
:param scale:
    (output) pattern scale value retrieved from etInstance.
...
:param index:
    (input) the index of the pattern scale to retrieve.
...
:param deltaxValue:
    (output) delta X value retrieved from etInstance.

:param deltayValue:
    (output) delta Y value retrieved from etInstance.
...
:param index:
    (input) the index of the pattern delta to retrieve.
...
:param cellName:
    (output) pattern cell name retrieved from etInstance.
...
:param index:
    (input) the index of the pattern cell to retrieve.
...
:param patternParams:
    (output) pattern parameters with deltas in uors and angles in radian.

:param modelRef:
    (input) reference model used to get the pattern parameters and scale.
...
:param index:
    (input) the index of the pattern parameters to retrieve.
...
:param textParams:
    (output) pattern style parameter set retrieved from etInstance.

:param textScale:
    (input) text scale retrieved from etInstance.

:param lineLength:
    (input) line length value retrieved from etInstance.

:param modelRef:
    (input) reference model used to get the text parameters and scale.

:param uorsPerMeter:
    (input) value used to convert pattern params to meters
...
:param styleId:
    (output) text style id retrieved from etInstance.

:param modelRef:
    (input) modelRef used to locate text style based on ID.
...
:param index:
    (input) the index of the text style id to retrieve.
...
:param styleName:
    (output) text style name retrieved from etInstance.
...
:param index:
    (input) the index of the text style to retrieve.
...
:param index:
    (input) the index of the point type and point information to retrieve.
Returns (Tuple, 0):
...
:param scale:
    (output) scale value retrieved from etInstance.
...
:param index:
    (input) the index of the scale to retrieve.
...
:param cellName:
    (output) terminator cell name string retrieved from etInstance.
...
:param index:
    (input) the index of the terminator cell name to retrieve.
...
:param cellScale:
    (output) cell scale value retrieved from etInstance.
...
:param index:
    (input) the index of the cell scale to retrieve.

:returns:
    ETSTATUS_Success if the cell scale at index is found in
    etInstance.)doc";

static const char* __doc_Bentley_DgnPlatform_ElementTemplateParamsHelper_GetCellFixedSize = R"doc(Get the cell fixed size on screen stored within the template instance.

:param cellFixedSize:
    (output) cell fixed size on screen value in inches retrieved from etInstance.
...
:param index:
    (input) the index of the cell fixed size to retrieve.

:returns:
    ETSTATUS_Success if the cell fixed size at index is found in
    etInstance.)doc";
...
:param cellName:
    (output) terminator cell name or cell name string retrieved from
    etInstance.
...
:param index:
    (input) the index of the name to retrieve.
...
:param cellName:
    (output) cell name string retrieved from etInstance.
...
:param index:
    (input) the index of the cell name to retrieve.
...
:param index:
    (input) the index of the fill mode to retrieve.
...
:param color:
    (output) solid fill color retrieved from etInstance.

:param gradientsymb:
    (output) gradient fill color retrieved from etInstance.

:param modelRef:
    (input) reference model used to get the solid fill color from the
...
:param index:
    (input) the index of the solid or gradient fill to retrieve.
...
:param index:
    (input) the index of the area mode to retrieve.
...
:param index:
    (input) the index of the priority to retrieve.
...
:param transparency:
    (output) transparency retrieved from etInstance.
...
:param index:
    (input) the index of the transparency to retrieve.
...
:param elementClass:
    (output) element class retrieved from etInstance.
...
:param index:
    (input) the index of the element class to retrieve.
...
:param lineStyleParams:
    (output) line style parameter set retrieved from etInstance.

:param uorsPerMeter:
    (input) value used to convert line style params to meters.
...
:param index:
    (input) the index of the line style to retrieve.
...
:param styleId:
    (output) line style id retrieved from etInstance.

:param isNamedStyle:
    (output) boolean value that determines whether or not the line style is
    named.

:param modelRef:
    (input) reference model used to search for the line style name from the
    associated DGNLIB file.
...
:param styleName:
    (output) line style name retrieved from etInstance.
...
:param weight:
    (output) weight retrieved from etInstance.
...
:param index:
    (input) the index of the weight to retrieve.
...
:param color:
    (output) element color retrieved from etInstance.

:param modelRef:
    (input) reference model used to get the element color from the
    associated struct.
...
:param index:
    (input) the index of the element color to retrieve.
...
:param modelRef:
    (input) reference model used to get the level id from the associated
    level name.
...
:param index:
    (input) the index of the level id to retrieve.
...
:param levelName:
    (output) name of the level retrieved from etInstance.
...
:param index:
    (input) the index of the level name to retrieve.
...
:param isNamedStyle:
    (output) if false the the string held a line code 0-7 or StyleByLevel
    or StyleByCell.

:param modelRef:
    (input) used to get DgnFile to pass to
...
:param numEntries:
    (output) number of values stored for the property defined by the
...
:param param:
    (input) defines the template property to process.
...
void def_ElementTemplateParamsHelper(py::module_& m)
    ...
    c1.def_static("GetCellFixedSize", &ElementTemplateParamsHelper::GetCellFixedSize, "cellFixedSize"_a, "etInstance"_a, "index"_a = 0, DOC(Bentley, DgnPlatform, ElementTemplateParamsHelper, GetCellFixedSize));
    ...
    c1.def_static("SetCellFixedSize", &ElementTemplateParamsHelper::SetCellFixedSize, "etInstance"_a, "cellFixedSize"_a, "index"_a = 0, DOC(Bentley, DgnPlatform, ElementTemplateParamsHelper, SetCellFixedSize));
    ...
    c1.def_static("AddCellFixedSize", &ElementTemplateParamsHelper::AddCellFixedSize, "etInstance"_a, "cellFixedSize"_a, DOC(Bentley, DgnPlatform, ElementTemplateParamsHelper, AddCellFixedSize));
