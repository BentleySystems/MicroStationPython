...
def test_CreateCurveElement_Example(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
...
def test_CreateCurveElement_BadArg(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
...
@pytest.mark.parametrize('fileName', ['3dMetricGeneral.dgn'])
def test_CreateCurveElement_MAX_VERTICES(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, True)
    points = DPoint3dArray()
...
@pytest.mark.parametrize('fileName', ['3dMetricGeneral.dgn'])
def test_CreateCurveElement_is3d(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, True)
...
@pytest.mark.parametrize('fileName', ['3dMetricGeneral.dgn'])
def test_CreateCurveElement_TemplateCopy(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, True)
    points = DPoint3dArray()
...
@pytest.mark.parametrize('fileName', ['3dMetricGeneral.dgn'])
def test_ICurveQuery_GetEndPoints_Curve(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, True)
...
@pytest.mark.parametrize('fileName', ['3dMetricGeneral.dgn'])
def test_ICurveQuery_GetComponentCount_ERROR_Curve(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, True)
    eeh = EditElementHandle()
    points = DPoint3dArray()
...
@pytest.mark.parametrize('fileName', ['3dMetricGeneral.dgn'])
def test_ICurveQuery_GetEndTangents_Curve(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, True)
...
@pytest.mark.parametrize('fileName', ['3dMetricGeneral.dgn'])
def test_ICurveQuery_GetClosestCurvePoint_Curve(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, True)
...
@pytest.mark.parametrize('fileName', ['3dMetricGeneral.dgn'])
def test_DisplayHandler_IsPlanar_CurveFail(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, True)
    points = DPoint3dArray()
    points.append(DPoint3d(0.0, -1.0, 0.0))
...
@pytest.mark.parametrize('fileName', ['3dMetricGeneral.dgn'])
def test_DisplayHandler_GetOrientation_Curve(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, True)
    points = DPoint3dArray()
    for i in range(NV):
...
@pytest.mark.parametrize('fileName', ['3dMetricGeneral.dgn'])
def test_DisplayHandler_GetTransformOrigin_Curve(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, True)
    points = DPoint3dArray()
    for i in range(NV):
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_DisplayHandler_IsRenderable_Curve(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, False)
    points = DPoint3dArray()
    for i in range(NV):
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_DisplayHandler_GetElemDisplayParams_Curve(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, False)
    points = DPoint3dArray()
    for i in range(NV):
...
@pytest.mark.parametrize('fileName', ['3dMetricGeneral.dgn'])
def test_DisplayHandler_GetSnapOrigin_Curve(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, True)
    points = DPoint3dArray()
    for i in range(NV):
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_DisplayHandler_IsPlanar_Curve(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, False)
    points = DPoint3dArray()
    for i in range(NV):
