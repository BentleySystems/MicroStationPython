...
def test_CreateLineElement_Example(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
...
def test_CreateLineString_MAX_VERTICES_1(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_CreateLineString_MAX_VERTICES_2(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, False)
    assert InitFilledCache (WString("2dMetricGeneral.dgn"), False, ret) == BentleyStatus.eSUCCESS
    m_eeh = EditElementHandle()
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_CreateLineString_BadArg(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, False)
    assert InitFilledCache (WString("2dMetricGeneral.dgn"), False, ret) == BentleyStatus.eSUCCESS
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_CreateLineString_is3d(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, False)
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_CreateLineString_Example(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, False)
    assert InitFilledCache (WString("2dMetricGeneral.dgn"), False, ret) == BentleyStatus.eSUCCESS
    points = DPoint3dArray()
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_CreatePointString_MAX_VERTICES(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, False)
    rt = RotMatrixArray()
    points = DPoint3dArray()
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_CreatePointString_BadArgs(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, False)
    rt = RotMatrixArray()
    points = DPoint3dArray()
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_CreatePointString_disjoint_false(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, False)
    NUM_VERTS=200
    assert InitFilledCache (WString("2dMetricGeneral.dgn"), False, ret) == BentleyStatus.eSUCCESS
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_CreatePointString_disjoint_true(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, False)
    NUM_VERTS=200
    assert InitFilledCache (WString("2dMetricGeneral.dgn"), False, ret) == BentleyStatus.eSUCCESS
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_CreatePointString_VerifyDefaultQuaterions3d(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, False)
    NUM_VERTS=2000
    rt = RotMatrixArray()
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_CreatPointString_VerifyDefaultQuaterions2d(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, False)
    NUM_VERTS=6
    rt = RotMatrixArray()
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_CreatPointString_VerifyDiffQuaterions3d(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, False)
    NUM_VERTS=2000
    rt = RotMatrixArray()
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_CreateShapeElement_WithSameEndPoints(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, False)
    points = DPoint3dArray()
    points.append(DPoint3d(0.0, 0.0, 0.0))
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_CreateShapeElement_WithDifferentEndPoints(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, False)
    points = DPoint3dArray()
    points.append(DPoint3d(0.0, 0.0, 0.0))
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_CreateShapeElement_WithDifferentEndPoints_MAX_VERTS(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, False)
    points = DPoint3dArray()
    GeneratePoints(points, MAX_VERTICES - 1)
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_CreateShapeElement_MAX_VERTICES(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, False)
    points = DPoint3dArray()
    GeneratePoints(points, MAX_VERTICES - 1)
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_CreateShapeElement_is3d(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, True)
    points = DPoint3dArray()
    GeneratePoints(points, MAX_VERTICES - 1)
...
@pytest.mark.parametrize('fileName', ['3dMetricGeneral.dgn'])
def test_ICurveQueryLine_GetEndPoints_Line(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, True)
    InitPoints()
...
@pytest.mark.parametrize('fileName', ['3dMetricGeneral.dgn'])
def test_ICurveQueryLine_GetEndTangents_Line(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, True)
    InitPoints()
    segment = DSegment3d(m_points[0], m_points[1])
...
@pytest.mark.parametrize('fileName', ['3dMetricGeneral.dgn'])
def test_ICurveQueryLine_GetClosestCurvePoint_Line(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, True)
    InitPoints()
    segment = DSegment3d(m_points[0], m_points[1])
...
@pytest.mark.parametrize('fileName', ['3dMetricGeneral.dgn'])
def test_ICurveQueryLineSring_GetEndPoints_Line(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, True)
    InitPoints()
    points = DPoint3dArray()
...
@pytest.mark.parametrize('fileName', ['3dMetricGeneral.dgn'])
def test_ICurveQueryLineString_GetEndTangents_Line(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, True)
    InitPoints()
    points = DPoint3dArray()
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_DisplayHandler_IsPlanar_Line(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, False)
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_DisplayHandler_IsPlanar_LineDef2(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, False)
    segment = DSegment3d(0, 0, 0, 100, 0, 0)
    assert LineHandler.CreateLineElement (m_eeh, None, segment, ret[0].Is3d(), ret[0]) == BentleyStatus.eSUCCESS
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_DisplayHandler_IsPlanar_LineDef3(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, False)
    segment = DSegment3d(0, 0, 0, 100, 0, 0)
    assert LineHandler.CreateLineElement (m_eeh, None, segment, ret[0].Is3d(), ret[0]) == BentleyStatus.eSUCCESS
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_DisplayHandler_IsPlanar_Line2(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    ret = srcDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, False)
