...
def test_ElementFromSurface(initDgnPlatformHost, loadDgnFile, createTempDgnFileWithSeed):
...
@pytest.mark.parametrize('fileName', ['3dMetricGeneral.dgn'])
def test_ElementFromSurface_CellElement(initDgnPlatformHost, loadDgnFile, createTempDgnFileWithSeed):
    fileSrc = os.environ['MSPYTEMPDATA']+ os.path.basename(__file__).split('.')[0] + str(sys._getframe().f_lineno)+'.dgn'
    srcDgnFile = createTempDgnFileWithSeed (fileSrc, loadDgnFile)
...
@pytest.mark.parametrize('fileName', ['3dMetricGeneral.dgn'])
def test_Handler_GetTypeName(initDgnPlatformHost, loadDgnFile, createTempDgnFileWithSeed):
    fileSrc = os.environ['MSPYTEMPDATA']+ os.path.basename(__file__).split('.')[0] + str(sys._getframe().f_lineno)+'.dgn'
    srcDgnFile = createTempDgnFileWithSeed (fileSrc, loadDgnFile)
...
@pytest.mark.parametrize('fileName', ['3dMetricGeneral.dgn'])
def test_DisplayHandler_GetOrientation(initDgnPlatformHost, loadDgnFile, createTempDgnFileWithSeed):
    fileSrc = os.environ['MSPYTEMPDATA']+ os.path.basename(__file__).split('.')[0] + str(sys._getframe().f_lineno)+'.dgn'
    srcDgnFile = createTempDgnFileWithSeed (fileSrc, loadDgnFile)
...
@pytest.mark.parametrize('fileName', ['3dMetricGeneral.dgn'])
def test_DisplayHandler_GetBsplineSurface(initDgnPlatformHost, loadDgnFile, createTempDgnFileWithSeed):
    fileSrc = os.environ['MSPYTEMPDATA']+ os.path.basename(__file__).split('.')[0] + str(sys._getframe().f_lineno)+'.dgn'
    srcDgnFile = createTempDgnFileWithSeed (fileSrc, loadDgnFile)
