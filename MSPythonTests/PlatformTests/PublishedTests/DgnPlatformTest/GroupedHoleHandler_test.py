...
def test_CreateGroupeHoleElement_NoHoles(initDgnPlatformHost, loadDgnFile):
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])  
def test_CreateGroupeHoleElement_InValidSolid(initDgnPlatformHost, loadDgnFile):
    ret = loadDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, False)
    solid = EditElementHandle ()
    shapeEeh = EditElementHandle ()
    holeEeh = EditElementHandle ()
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])  
def test_IsGroupedHole_true(initDgnPlatformHost, loadDgnFile):
    ret = loadDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, False)
    solid = EditElementHandle ()
    shapeEeh = EditElementHandle ()
    holeEeh = EditElementHandle ()
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])  
def test_IsGroupedHole_false(initDgnPlatformHost, loadDgnFile):
    ret = loadDgnFile.CreateNewModel ("Test", DgnModelType.eNormal, False)
    shapeEeh = EditElementHandle ()
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])  
def test_IsValidGroupedHoleComponentType_Shape(initDgnPlatformHost, loadDgnFile):
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])  
def test_IsValidGroupedHoleComponentType_Ellipse(initDgnPlatformHost, loadDgnFile):
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_IsValidGroupedHoleComponentType_ComplexShape(initDgnPlatformHost, loadDgnFile):
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])  
def test_IsValidGroupedHoleComponentType_BSpline(initDgnPlatformHost, loadDgnFile):
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])  
def test_IsValidGroupedHoleComponentType_false(initDgnPlatformHost, loadDgnFile):
