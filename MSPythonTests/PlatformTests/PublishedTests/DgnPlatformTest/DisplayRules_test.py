...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_GetDisplayRuleSetsInFile(initDgnPlatformHost, loadDgnFile, createTempDgnFileWithSeed):
    global m_displayRuleSet0, m_displayRuleSet1
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_GetDisplayRuleSetByName(initDgnPlatformHost, loadDgnFile, createTempDgnFileWithSeed):
    global m_displayRuleSet0, m_displayRuleSet1
    fileSrc = os.environ['MSPYTEMPDATA'] + os.path.basename(__file__).split('.')[0] + str(sys._getframe().f_lineno)+'.dgn'
    srcDgnFile = createTempDgnFileWithSeed(fileSrc, loadDgnFile)
    SetUpOverride(srcDgnFile)
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_RenameDisplayRuleSetInFile(initDgnPlatformHost, loadDgnFile, createTempDgnFileWithSeed):
    global m_displayRuleSet0, m_displayRuleSet1
    fileSrc = os.environ['MSPYTEMPDATA'] + os.path.basename(__file__).split('.')[0] + str(sys._getframe().f_lineno)+'.dgn'
    srcDgnFile = createTempDgnFileWithSeed(fileSrc, loadDgnFile)
    SetUpOverride(srcDgnFile)
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_RemoveDisplayRuleSetFromFile(initDgnPlatformHost, loadDgnFile, createTempDgnFileWithSeed):
    global m_displayRuleSet0, m_displayRuleSet1
    fileSrc = os.environ['MSPYTEMPDATA'] + os.path.basename(__file__).split('.')[0] + str(sys._getframe().f_lineno)+'.dgn'
    srcDgnFile = createTempDgnFileWithSeed(fileSrc, loadDgnFile)
    SetUpOverride(srcDgnFile)
