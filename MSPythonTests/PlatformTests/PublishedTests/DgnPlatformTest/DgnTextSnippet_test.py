...
def test_RemapTextSnippetTest(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    emptyDir = WString ()
    ...
    fileTarget =  str(emptyDir) + os.path.basename(__file__).split('.')[0] + str(sys._getframe().f_lineno)+'.dgn'
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_DgnTextSnippetCollectionAndIteratorTest(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_DgnTextSnippetReplaceTest(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_DgnTextSnippetCopyValuesTest(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    snippetName = "CopyValuesTest1"
    snippet1 = DgnTextSnippet.Create(snippetName, srcDgnFile)
    assert None != snippet1
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_SetCategoryTest(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_AddSubCategoryTest(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_BuildCategoryTreeTest(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    rootCategoryName = "RootCategory"
    rootCategory = DgnTextSnippetCategory(rootCategoryName, srcDgnFile)
    assert None != rootCategory
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_RemoveSubCategoryTest(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    rootCategoryName = "RootCategory"
    rootCategory = DgnTextSnippetCategory(rootCategoryName, srcDgnFile)
    assert None != rootCategory
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_RenameCategoryTest(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    rootCategoryName = "RootCategory"
    rootCategory = DgnTextSnippetCategory(rootCategoryName, srcDgnFile)
    assert None != rootCategory
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_GetTextFavoritesTest(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
...
@pytest.mark.parametrize('fileName', ['2dMetricGeneral.dgn'])
def test_GetParentCategoryTest(initDgnPlatformHost, loadDgnFile, createTempDgnFileFromSeed):
    srcDgnFile = createTempDgnFileFromSeed (loadDgnFile)
    rootCategoryName = "RootCategory"
    rootCategory = DgnTextSnippetCategory(rootCategoryName, srcDgnFile)
    assert None != rootCategory
